...
Source0  : https://github.com/icecc/icecream/releases/download/1.3/icecc-1.3.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576132259
...
cp %{_builddir}/icecc-1.3/COPYING %{buildroot}/usr/share/package-licenses/icecream/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
