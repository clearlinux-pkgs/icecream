...
Version  : 1.3.1
Release  : 9
URL      : https://github.com/icecc/icecream/releases/download/1.3.1/icecc-1.3.1.tar.xz
Source0  : https://github.com/icecc/icecream/releases/download/1.3.1/icecc-1.3.1.tar.xz
...
%prep
%setup -q -n icecc-1.3.1
cd %{_builddir}/icecc-1.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1580879951
...
cp %{_builddir}/icecc-1.3.1/COPYING %{buildroot}/usr/share/package-licenses/icecream/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
